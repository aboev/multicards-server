...
ActiveRecord::Schema.define(version: 20160309131025) do
  ...
  create_table "flag_log", force: true do |t|
    t.integer  "user_id"
    t.string   "gid"
    t.string   "flag_id"
    t.datetime "created_at"
  ...
  create_table "games", force: true do |t|
    ...
    t.string   "player1_status"
    t.string   "player2_status"
  end
  ...
  create_table "tag_log", force: true do |t|
    t.integer  "user_id"
    t.string   "gid"
    t.string   "tag_id"
    t.datetime "created_at"
